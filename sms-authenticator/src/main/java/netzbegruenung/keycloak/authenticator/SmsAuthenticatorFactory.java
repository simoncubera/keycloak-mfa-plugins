...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("smsProvider", "SMS Provider", "The SMS provider, used to determine the payload format", ProviderConfigProperty.LIST_TYPE, "generic", "generic", "azure"),
